 ...
 * extended all references should be to Potion
 */
public abstract class BasePotion extends BaseObject
{
    /** Serial version */
    private static final long serialVersionUID = 1237801015996L;

    /** The Peer class */
    private static final PotionPeer peer =
        new PotionPeer();
        ...
        throws TorqueException, IllegalArgumentException
    {
        ...
        if (name.equals("Use"))
        {
            ...
            setUse(((Boolean)value).booleanValue());
            return true;
        }
        return false;
    }
    ...
    {
        if (name.equals(PotionPeer.ID_OBJET))
        {
            return new Integer(getIdObjet());
        }
        if (name.equals(PotionPeer.NOM))
        {
            return getNom();
        }
        if (name.equals(PotionPeer.BONUSATTAQUE))
        {
            return new Integer(getBonusattaque());
        }
        if (name.equals(PotionPeer.BONUSDEGAT))
        {
            return new Integer(getBonusdegat());
        }
        if (name.equals(PotionPeer.BONUSESQUIVE))
        {
            return new Integer(getBonusesquive());
        }
        if (name.equals(PotionPeer.BONUSVIE))
        {
            return new Integer(getBonusvie());
        }
        if (name.equals(PotionPeer.DUREE))
        {
            return new Integer(getDuree());
        }
        if (name.equals(PotionPeer.USE))
        {
            return new Boolean(getUse());
        }
        return null;
    ...
    public boolean setByPeerName(String name, Object value)
        throws TorqueException, IllegalArgumentException
    {
      if (PotionPeer.ID_OBJET.equals(name))
        {
            return setByName("IdObjet", value);
        }
      if (PotionPeer.NOM.equals(name))
        {
            return setByName("Nom", value);
        }
      if (PotionPeer.BONUSATTAQUE.equals(name))
        {
            return setByName("Bonusattaque", value);
        }
      if (PotionPeer.BONUSDEGAT.equals(name))
        {
            return setByName("Bonusdegat", value);
        }
      if (PotionPeer.BONUSESQUIVE.equals(name))
        {
            return setByName("Bonusesquive", value);
        }
      if (PotionPeer.BONUSVIE.equals(name))
        {
            return setByName("Bonusvie", value);
        }
      if (PotionPeer.DUREE.equals(name))
        {
            return setByName("Duree", value);
        }
      if (PotionPeer.USE.equals(name))
        {
            return setByName("Use", value);
        }
        return false;
    }
    ...
    public void save(Connection con) throws TorqueException
    {
        if (!alreadyInSave)
        {
            ...
            if (isModified())
            {
                if (isNew())
                {
                    PotionPeer.doInsert((Potion) this, con);
                    setNew(false);
                }
                else
                {
                    PotionPeer.doUpdate((Potion) this, con);
                }
            }
     ...
     */
    public Potion copy() throws TorqueException
    {
        return copy(true);
    }
     ...
     */
    public Potion copy(Connection con) throws TorqueException
    {
     ...
     */
    public Potion copy(boolean deepcopy) throws TorqueException
    {
        return copyInto(new Potion(), deepcopy);
    }
     ...
     * @param con the database connection to read associated objects.
     */
    public Potion copy(boolean deepcopy, Connection con) throws TorqueException
    {
        return copyInto(new Potion(), deepcopy, con);
    }
     ...
     */
    protected Potion copyInto(Potion copyObj) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected Potion copyInto(Potion copyObj, Connection con) throws TorqueException
    {
     ...
     */
    protected Potion copyInto(Potion copyObj, boolean deepcopy) throws TorqueException
    {
     ...
     * @param con the database connection to read associated objects.
     */
    protected Potion copyInto(Potion copyObj, boolean deepcopy, Connection con) throws TorqueException
    {
        copyObj.setIdObjet(idObjet);
        copyObj.setNom(nom);
        copyObj.setBonusattaque(bonusattaque);
